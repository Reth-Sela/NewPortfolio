  ...
  return (
    <div className="bg-gray-400 mt-[20px] border border-b-2 border-white pb-[50px]">
      ...
      <div className='flex mt-[10px] gap-2 mx-3'>
        <ContactComponent imgScr={email} text={'selareth7@gmail.com'} background={'bg-gray-500'}/>
        <ContactComponent imgScr={location} text={'Charmka dong PP'}  background={'bg-blue-500'}/>
        <ContactComponent imgScr={email} text={'selareth7@gmail.com'} background={'bg-gray-500'}/>
      </div>
    </div>
  );
